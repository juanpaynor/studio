-- Fix the table reference issue in create_order_with_sale function
-- This fixes the "missing FROM-clause entry for table create_order_with_sale" error
...
BEGIN
    ...
    -- Prepare receipt data - FIXED: use variable sale_id, not function name
